...
// 1. api-client.ts
fs.writeFileSync(path.join(srcLibDir, 'api-client.ts'), [
  ...
  "  const baseUrl = process.env.NEXT_PUBLIC_AZURE_API_URL || 'http://localhost:3000';",
  "  ",
...
console.log("Phase 12 Frontend Refactoring scaffolded.");
