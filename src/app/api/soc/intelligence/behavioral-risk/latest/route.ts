...
import { getLatestBehavioralRiskAssessmentForSubject } from '@/lib/security/intelligence/behavioral-risk.queries';
...
export async function GET(request: Request) {
  try {
    ...
    const result = await getLatestBehavioralRiskAssessmentForSubject({
