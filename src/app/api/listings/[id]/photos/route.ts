...
import { validateUploadRequest, LISTING_PHOTO_POLICY, handleUploadError } from '@/lib/security/upload-security';
...
export async function POST(req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    // Check count first to avoid unneeded file buffering if it's already full
