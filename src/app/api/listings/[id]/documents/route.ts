...
import { validateUploadRequest, LISTING_DOCUMENT_POLICY, handleUploadError } from '@/lib/security/upload-security';
...
export async function POST(req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const validation = await validateUploadRequest(formData, 'file', LISTING_DOCUMENT_POLICY);
