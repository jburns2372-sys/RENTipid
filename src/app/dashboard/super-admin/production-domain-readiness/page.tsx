...
const TRACKING_KEYS = [
  ...
  { key: 'DOMAIN_APP_BASE_URL_HTTPS', label: 'APP_BASE_URL starts with https://' },
  { key: 'DOMAIN_APP_BASE_URL_NOT_LOCALHOST', label: 'Not localhost' },
  { key: 'DOMAIN_PAYMONGO_ACTIVATION_STATUS', label: 'PayMongo activation pending/approved' },
  { key: 'DOMAIN_LIVE_PAYMENT_BLOCKED', label: 'Live payment remains blocked until all checks pass' },
