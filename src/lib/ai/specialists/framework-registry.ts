...
export const revision2SpecialistRegistry: Readonly<Record<Revision2SpecialistId, Revision2SpecialistDefinition>> = {
  ...
  ProviderAcquisitionSpecialist: {
    ...
    maturityLevel: 'L2_DRAFT',
    allowedRoles: ['Admin', 'Super Admin', 'Provider', 'Individual Provider', 'Business Provider'],
    prohibitedRoles: ['Guest', 'Renter'],
    allowedKnowledgeDomains: [
      'provider_qualification_rules',
      'onboarding_requirements',
      'market_supply_gaps',
      'listingbridge_rules',
      'listingbridge_taxonomy',
    ],
    prohibitedKnowledgeDomains: ['raw_kyc_documents', 'payment_credentials', 'security_secrets', 'individual_pii', 'support_conversations'],
    allowedTools: [
      'getListingBridgeReviewSummary',
      'identifyListingBridgeMissingFields',
      'explainListingBridgeConflict',
      'suggestListingBridgeAmenityMapping',
      'suggestListingBridgePropertyCategory',
      'draftListingBridgeOriginalDescription',
    ],
  ...
  IncidentRCASpecialist: {
    id: 'IncidentRCASpecialist',
    version: '1.0',
    status: 'ENABLED',
    featureFlag: 'ai_specialist_incident_rca_enabled',
    maturityLevel: 'L1_OBSERVE_RECOMMEND',
    allowedRoles: ['Admin', 'Super Admin', 'Security Officer'],
    prohibitedRoles: ['Guest', 'Renter', 'Provider', 'Individual Provider', 'Business Provider'],
    allowedKnowledgeDomains: ['system_logs', 'api_errors', 'deployment_events', 'processor_telemetry'],
    prohibitedKnowledgeDomains: ['raw_kyc_documents', 'individual_pii', 'security_secrets', 'payment_credentials'],
    allowedTools: [],
    prohibitedTools: [...alwaysProhibitedTools, 'restart_service', 'deploy', 'rollback', 'run_migration', 'restart_worker', 'change_schema'],
    riskCeiling: 'INFORMATION',
  },
  ContractPolicySpecialist: {
    id: 'ContractPolicySpecialist',
    version: '1.0',
    status: 'ENABLED',
    featureFlag: 'ai_specialist_contract_policy_enabled',
    maturityLevel: 'L1_OBSERVE_RECOMMEND',
    allowedRoles: ['Admin', 'Super Admin', 'Legal Reviewer'],
    prohibitedRoles: ['Guest', 'Renter', 'Provider', 'Individual Provider', 'Business Provider'],
    allowedKnowledgeDomains: ['internal_policy_drafts', 'provider_agreements', 'vendor_agreements'],
    prohibitedKnowledgeDomains: ['raw_kyc_documents', 'individual_pii', 'security_secrets', 'payment_credentials'],
    allowedTools: [],
    prohibitedTools: [...alwaysProhibitedTools, 'approve_contract', 'execute_contract', 'sign_contract', 'accept_terms', 'publish_policy', 'modify_customer_terms'],
    riskCeiling: 'INFORMATION',
  },
  ProductUXSpecialist: {
    id: 'ProductUXSpecialist',
    version: '1.0',
    status: 'ENABLED',
    featureFlag: 'ai_specialist_product_ux_enabled',
    maturityLevel: 'L1_OBSERVE_RECOMMEND',
    allowedRoles: ['Admin', 'Super Admin', 'Product Manager', 'UX Designer'],
    prohibitedRoles: ['Guest', 'Renter', 'Provider', 'Individual Provider', 'Business Provider'],
    allowedKnowledgeDomains: ['product_telemetry', 'ux_artifacts', 'support_aggregates'],
    prohibitedKnowledgeDomains: ['raw_support_transcripts', 'individual_pii', 'security_secrets', 'payment_credentials'],
    allowedTools: [],
    prohibitedTools: [...alwaysProhibitedTools, 'deploy', 'push_code', 'commit_code', 'activate_experiment', 'change_policy', 'modify_production_ui'],
    riskCeiling: 'INFORMATION',
  },
};