...
const INTENTS: SemanticLexiconEntry[] = [
  ...
  },
  {
    ...
    type: 'INTENT',
    domain: 'Core',
    aliases: ['sign up', 'register', 'create account', 'join rentipid', 'become a renter'],
    abbreviations: [],
  ...
  {
    canonicalId: 'PROVIDER_ONBOARDING',
    canonicalTerm: 'Provider Onboarding',
    type: 'INTENT',
    domain: 'Core',
    aliases: ['become a provider', 'register as a provider', 'provider registration'],
    abbreviations: [],
    commonMisspellings: ['becme a provider', 'become provider'],
    colloquialForms: ['start providing rentals'],
    audience: 'CUSTOMER',
    source: 'CONTROLLED_REGISTRY',
    status: 'ACTIVE',
    version: CONTROLLED_REGISTRY_VERSION,
