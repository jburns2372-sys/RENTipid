...
export class TikTokSocialAdapter implements SocialAdapter {
  platformId: SocialPlatform = SOCIAL_PLATFORMS.TIKTOK;

  getCapabilities(): ProviderCapability[] {
    return [
      'accountConnection', 'accountValidation', 'healthCheck', 
      'publishVideo', 'analytics', 'feedback', 'webhookEvents'
    ];
  }
