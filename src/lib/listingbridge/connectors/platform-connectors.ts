...
// RETIRED: Runtime connector registration decommissioned per Owner decision.
export function createListingBridgePlatformConnectors(): readonly { connector: any; descriptor: ListingBridgeConnectorDescriptor }[] {
  return [];
}
