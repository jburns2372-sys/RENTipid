...
| **Infra Admin** | Production deployment and secret injection | DevOps/Infra Admin | Vercel & Neon configuration verification | CI/CD production pipelines, secrets configuration | Exposure of raw secrets |
...
| **Database Admin** | Production DB read-only access provisioning | Database Administrator (Neon) | Schema migration verification | Execution of Phase 17 Integrity Check | Direct SQL write access |
