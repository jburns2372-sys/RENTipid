# ADR 15: PWA and Capacitor Compatibility

## Context
Rentipid is migrating to an Azure backend while maintaining Vercel frontend delivery.

## Decision
Implementing strict CORS policies on APIM and ensuring the frontend securely propagates JWT headers to avoid blocking mobile app requests.
