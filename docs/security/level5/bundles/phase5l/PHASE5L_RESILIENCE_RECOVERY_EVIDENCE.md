...
- **FINAL_GUARD_TEST_TOTAL**: 13
- **FINAL_GUARD_TEST_FAILED**: 0
- **FINAL_GUARD_TEST_SKIPPED**: 0
- **PLACEHOLDER_TESTS_REMOVED**: true
- **DATABASE_URLS_EMBEDDED_IN_SOURCE**: false
- **HARDCODED_DATABASE_PASSWORD**: false
- **STRICT_URL_PARSING**: true
- **EVIL_LOCALHOST_REJECTED**: true
- **CHECKSUM_REVERIFIED_BEFORE_RESTORE**: true
- **FAILED_DRILL_RETURNS_NONZERO**: true
- **DATABASE_DISCONNECT_AWAITED**: true
- **FINAL_ISOLATED_DRILL_COMPLETED**: true
- **FINAL_RESTORE_EXIT_CODE**: 0
- **FINAL_ROW_COUNT_DIFFERENCE**: 0
- **FINAL_FINANCIAL_TOTAL_DIFFERENCE**: 0
- **FINAL_RESTORE_HASH_RECONCILIATION**: PASSED
